...
def handle_disconnect():
    if current_user.is_authenticated:
        ...
        # Повідомляємо ВСІХ, що юзер офлайн
        emit('user_status_change', 
...
def handle_send_message(data):
    ...
    # === План А: Сповіщення про непрочитане ===
    # Якщо отримувач онлайн, але (можливо) не в чаті, 
    # надсилаємо йому окрему подію 'unread'
...
def handle_load_history(data):
    ...
    # === План Б: Додатково надсилаємо список тих, хто онлайн ===
